...
class PathRecorder(Node):
    ...
    def __init__(self):
        ...
        # self.csv_file = open('/home/nontanan/robinz_ws/src/path_tracking/csv/recorded_path.csv', 'w', newline='')
        self.csv_file = open('/home/nontanan/robinz_ws/src/path_tracking/csv/waypoint.csv', 'w', newline='')
